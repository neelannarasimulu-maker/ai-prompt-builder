...
export function useGeneratedContentCoordination(scope: ReturnType<typeof usePromptCompilation>) {
  ...
  const generatedContent = useGeneratedContent(inferredGeneratedCategory);
  const {
  ...
  return { ...scope, inferredGeneratedCategory, selectedGeneratedCategory, setSelectedGeneratedCategory, uploadCategory, setUploadCategory, generatedFiles, setGeneratedFiles, selectedGeneratedFileId, setSelectedGeneratedFileId, generatedSearch, setGeneratedSearch, selectedGeneratedVersion, setSelectedGeneratedVersion, selectedGeneratedFileIds, setSelectedGeneratedFileIds, isExportingGeneratedContent, setIsExportingGeneratedContent, isRenderingDocument, setIsRenderingDocument, targetFolder, setTargetFolder };
}
