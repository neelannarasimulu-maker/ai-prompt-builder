...
export function useContentSave(scope: ReturnType<typeof useReviewCoordination>) {
  ...
  return { ...scope, handleSaveContentSource, handleSaveProjectChrome };
}
